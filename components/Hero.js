...
//         <Image src="/addu-building.png" alt="AdDU" fill style={{ objectFit: 'cover', opacity: 0.18 }} />
//       </div>
...
//             <Image src="/knight-logo.png" alt="Blue Knight" width={160} height={160} style={{ objectFit: 'contain', filter: 'drop-shadow(0 0 40px rgba(245,192,37,0.3))' }} />
//           </div>
